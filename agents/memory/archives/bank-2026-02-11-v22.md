...
- **L140:** Complete specification layers before implementation eliminates Day 1 ambiguity — user stories, implementation contract, UX spec, test strategy all ready
- **L141:** Self-dogfooding documentation with rigor (methodology, metrics, threats to validity) converts marketing claim to research contribution
- **L142:** Pre-launch metrics refresh is mandatory for accelerator applications — stale metrics signal inattention to detail
