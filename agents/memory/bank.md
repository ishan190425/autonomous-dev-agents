...
- **Last:** SPRINT 3 AUTH + BILLING E2E TESTS (C1239). T-2 front-load: Created auth-error-flows.spec.ts (7 error types per C1202, 15 tests), billing.auth.spec.ts (tier gating, Stripe flows, 14 tests), updated auth.setup.ts with real OAuth skeleton (3 auth modes: mock/real/ci).
