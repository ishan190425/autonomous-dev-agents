# 💰 Investor Research — Pre-Seed Target List
...
ADA is raising a **$500K-$2M pre-seed round** to:

1. Expand the founding team (2-3 engineers)
2. Scale infrastructure for public launch
...
### Tier 1: AI-Native Funds (Primary Targets)

These funds focus specifically on AI infrastructure, developer tools, and frontier AI applications.

| Fund                   | Focus                | Check Size | Key Partners                | Notes                                                        |
| ---------------------- | -------------------- | ---------- | --------------------------- | ------------------------------------------------------------ |
| **Amplify Partners**   | AI/ML infrastructure | $1-3M      | Sunil Dhaliwal, Mike Dauber | Portfolio: Weights & Biases, Vercel. Strong devtools thesis. |
| **Boldstart Ventures** | DevTools, Enterprise | $1-3M seed | Ed Sim, Eliot Durbin        | Portfolio: Snyk, BigID. Early enterprise focus.              |
| **Conviction**         | Frontier AI          | $1-5M      | Sarah Guo                   | AI-first fund. Former Greylock. Deep AI network.             |
| **Gradient Ventures**  | Google's AI fund     | $1-5M      | Anna Patterson              | Strategic value + capital. AI ecosystem access.              |
| **Radical Ventures**   | AI moonshots         | $2-10M     | Jordan Jacobs               | Portfolio: Cohere, Waabi. Academic connections.              |

**Why Tier 1:** These investors understand multi-agent systems, will get the vision immediately, and can provide strategic value beyond capital.

### Tier 2: Premier Seed Funds

Generalist seed funds with strong AI/devtools portfolio presence.

| Fund                    | Focus                | Check Size | Key Partners                   | Notes                                                |
| ----------------------- | -------------------- | ---------- | ------------------------------ | ---------------------------------------------------- |
| **First Round Capital** | Consumer, Enterprise | $1-3M      | Josh Kopelman, Bill Trenchard  | Operator network. Portfolio: Notion, Roblox.         |
| **Accel**               | Enterprise, SaaS     | $1-5M      | Sonali De Rycker, Rich Wong    | Portfolio: Slack, Dropbox, UiPath. Deep enterprise.  |
| **a16z (Seed)**         | Infrastructure       | $1-3M      | Martin Casado                  | Known for infra bets. Portfolio: Databricks, dbt.    |
| **Greylock**            | Enterprise           | $2-5M      | Reid Hoffman, Jerry Chen       | LinkedIn network. Strong enterprise thesis.          |
| **Bessemer**            | DevTools, Cloud      | $1-5M      | Mary D'Onofrio, Ethan Kurzweil | Portfolio: Twilio, Auth0, Airbyte. DevOps expertise. |

### Tier 3: AI-Focused Angels

Strategic angels who can provide expertise, network, and credibility.

| Angel               | Background       | Check Size | Why Target                             |
| ------------------- | ---------------- | ---------- | -------------------------------------- |
| **Nat Friedman**    | Ex-GitHub CEO    | $100K-500K | DevTools credibility, AI Labs advisor  |
| **Elad Gil**        | Ex-Google, Color | $100K-250K | Deep AI network, operator expertise    |
| **Sarah Guo**       | Conviction GP    | $25K-100K  | Frontier AI expertise (if not leading) |
| **Guillermo Rauch** | Vercel CEO       | $50K-150K  | DevTools, open-source strategy         |
| **Pieter Levels**   | Nomad List       | $25K-50K   | Solo founder, viral distribution       |
| **Daniel Gross**    | Pioneer CEO      | $50K-150K  | Pioneer connection, AI expertise       |
| **Greg Brockman**   | OpenAI President | $100K-500K | Long shot but perfect fit              |
| **Andrej Karpathy** | Ex-Tesla AI      | $50K-250K  | AI education, dev community reach      |

### Tier 4: Strategic Corporate

Companies with strategic interest in AI dev infrastructure.

| Company       | Division     | Strategic Value                     | Notes                          |
| ------------- | ------------ | ----------------------------------- | ------------------------------ |
| **Anthropic** | Ecosystem    | Preferred LLM pricing, co-marketing | Claude is our primary LLM      |
| **OpenAI**    | Startup Fund | API credits, ecosystem visibility   | Competitive with Anthropic     |
| **Microsoft** | M12          | GitHub integration, Azure credits   | GitHub Copilot competitor risk |
| **Google**    | Gradient     | GCP credits, AI ecosystem           | May want exclusivity           |
...
- Market timing: AI coding tools hitting limitations
- Distribution: GitHub, npm, developer communities
...
- Capital efficiency (AI team = infinite engineers)
- Quick wins potential (viral launch possible)
- Fun factor (this is exciting AI!)
...
| Aspect | Copilot          | ADA                |
| ------ | ---------------- | ------------------ |
| Mode   | Autocomplete     | Autonomous         |
| Scope  | Code suggestions | Full dev lifecycle |
| Agent  | Single           | Multi-role team    |
| Memory | None             | Persistent bank    |

**Pitch:** "Copilot helps you write code. ADA helps you ship products."
